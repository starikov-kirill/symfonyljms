<?php
    ...
    class User implements AdvancedUserInterface, \Serializable {
        ...
        /**
         * @ORM\ManyToMany(targetEntity="Divisions")
         * @ORM\JoinTable(name="directors_divisions",
         * joinColumns={@ORM\JoinColumn(name="user_id", referencedColumnName="id")},
         * inverseJoinColumns={@ORM\JoinColumn(name="division_id", referencedColumnName="id", unique=true)}
         * )
         */
        private $divisions;
        ...
        public function __construct()
        {
            ...
            $this->teamsManagers = new ArrayCollection();
            $this->teamsCoachs = new ArrayCollection();
        }
     ...
     * Add divisions
     *
     * @param \Ljms\GeneralBundle\Entity\Divisions $divisions
     * @return User
     */
    public function addDivision(\Ljms\GeneralBundle\Entity\Divisions $divisions)
    {
     ...
     * @param \Ljms\GeneralBundle\Entity\Divisions $divisions
     */
    public function removeDivision(\Ljms\GeneralBundle\Entity\Divisions $divisions)
    {
     ...
     * Add teamsManagers
     *
     * @param \Ljms\GeneralBundle\Entity\Teams $teamsManagers
     * @return User
     */
    public function addTeamsManager(\Ljms\GeneralBundle\Entity\Teams $teamsManagers)
    {
    ...
    /**
     * Remove teamsManagers
     *
     * @param \Ljms\GeneralBundle\Entity\Teams $teamsManagers
     */
    public function removeTeamsManager(\Ljms\GeneralBundle\Entity\Teams $teamsManagers)
    {
        $this->teamsManagers->removeElement($teamsManagers);
    }
     ...
     * @return \Doctrine\Common\Collections\Collection 
     */
    public function getTeamsManagers()
    {
        return $this->teamsManagers;
    }

    /**
     * Add teamsCoachs
     *
     * @param \Ljms\GeneralBundle\Entity\Teams $teamsCoachs
     * @return User
     */
    public function addTeamsCoach(\Ljms\GeneralBundle\Entity\Teams $teamsCoachs)
    {
        $this->teamsCoachs[] = $teamsCoachs;
     ...
     * @param \Ljms\GeneralBundle\Entity\Teams $teamsCoachs
     */
    public function removeTeamsCoach(\Ljms\GeneralBundle\Entity\Teams $teamsCoachs)
    {
        $this->teamsCoachs->removeElement($teamsCoachs);
    }
     ...
     * @return \Doctrine\Common\Collections\Collection 
     */
    public function getTeamsCoachs()
    {
        return $this->teamsCoachs;
    }
}
